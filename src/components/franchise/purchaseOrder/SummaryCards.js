...
function SummaryCards({ summary }) {
  return React.createElement(CardsContainer, null,
    ...
    React.createElement(Card, null,
      ...
      React.createElement(CardContent, null,
        React.createElement(CardTitle, null, '대기 중'),
        React.createElement(CardValue, null, summary.pending)
      )
    ),
    React.createElement(Card, null,
      React.createElement(IconContainer, { type: 'inProgress' },
        React.createElement('span', null, '🚚')
      ),
      React.createElement(CardContent, null,
        React.createElement(CardTitle, null, '처리 중'),
        React.createElement(CardValue, null, summary.inProgress)
      )
    ),
    React.createElement(Card, null,
