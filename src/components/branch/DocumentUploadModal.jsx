...
function DocumentUploadModal({ isOpen, onClose, employeeId, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      uploadFormData.append('documentUrl', formData.documentUrl);
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            <FileInputContainer>
              ...
              <FileInputText>
                {formData.documentUrl ? formData.documentUrl.name : '선택된 파일 없음'}
              </FileInputText>
            </FileInputContainer>
            {errors.documentUrl && <ErrorMessage>{errors.documentUrl}</ErrorMessage>}
          </FormGroup>
